...
#            (currentangle_c, endpose_c[0], endpose_c[1], endpose_c[2]))
    ...
    if endpose[2] == 0: # move forward
        ...
        if angleIndex==0 and endpose[2]==-1:
            ...
            startangle = -2*math.pi/numAngles
...
endpose_angle0_vel0[8,:] = [4, -1, -1, 1]   # forward turn cw long -> vel1
endpose_angle0_vel0[9,:] = [4, -1, -1, 2]   # forward turn cw long -> vel2
...
endpose_angle0_vel1[6,:] = [2, -1, -1, 0]   # forward turn cw -> vel0 
endpose_angle0_vel1[7,:] = [2, -1, -1, 1]   # forward turn cw -> vel1 
endpose_angle0_vel1[8,:] = [2, -1, -1, 2]   # forward turn cw -> vel2 
...
endpose_angle0_vel1[15,:] = [8, -1, -1, 1]  # forward turn cw long -> vel1
endpose_angle0_vel1[16,:] = [8, -1, -1, 2]  # forward turn cw long -> vel2
endpose_angle0_vel1[17,:] = [8, -1, -1, 3]  # forward turn cw long -> vel3
...
endpose_angle0_vel2[6,:] = [4, -1, -1, 1]   # forward turn cw -> vel1
endpose_angle0_vel2[7,:] = [4, -1, -1, 2]   # forward turn cw -> vel2
endpose_angle0_vel2[8,:] = [4, -1, -1, 3]   # forward turn cw -> vel3
...
endpose_angle0_vel2[13,:] = [8, -1, -1, 2]  # forward turn cw long -> vel2
endpose_angle0_vel2[14,:] = [8, -1, -1, 3]  # forward turn cw long -> vel3
...
endpose_angle0_vel3[4,:] = [4, -1, -1, 2]   # forward turn cw -> vel2
endpose_angle0_vel3[5,:] = [4, -1, -1, 3]   # forward turn cw -> vel3
endpose_angle0_vel3[6,:] = [8, 0, 0, 3]     # forward long -> vel3
endpose_angle0_vel3[7,:] = [8, 1, 1, 3]     # forward turn ccw long ->vel3
endpose_angle0_vel3[8,:] = [8, -1, -1, 3]   # forward turn cw long -> vel3
...
endpose_angle22p5_vel0[5,:] = [4, 2, 0, 2]     # forward long -> vel2
endpose_angle22p5_vel0[6,:] = [3, 2, 1, 1]     # forward turn ccw long ->vel1
endpose_angle22p5_vel0[7,:] = [3, 2, 1, 2]     # forward turn ccw long ->vel2
endpose_angle22p5_vel0[8,:] = [4, 1, -1, 1]     # forward turn cw long -> vel1
endpose_angle22p5_vel0[9,:] = [4, 1, -1, 2]     # forward turn cw long -> vel2

endpose_angle22p5_vel1[0,:] = [2, 1, 0, 0]     # forward -> vel0
endpose_angle22p5_vel1[1,:] = [2, 1, 0, 1]     # forward -> vel1
endpose_angle22p5_vel1[2,:] = [2, 1, 0, 2]     # forward -> vel2
endpose_angle22p5_vel1[3,:] = [3, 2, 1, 0]     # forward turn ccw -> vel0
endpose_angle22p5_vel1[4,:] = [3, 2, 1, 1]     # forward turn ccw -> vel1
endpose_angle22p5_vel1[5,:] = [3, 2, 1, 2]     # forward turn ccw -> vel2
endpose_angle22p5_vel1[6,:] = [4, 1, -1, 0]     # forward turn cw -> vel0 
endpose_angle22p5_vel1[7,:] = [4, 1, -1, 1]     # forward turn cw -> vel1 
endpose_angle22p5_vel1[8,:] = [4, 1, -1, 2]     # forward turn cw -> vel2 
endpose_angle22p5_vel1[9,:] = [8, 4, 0, 1]     # forward long -> vel1
endpose_angle22p5_vel1[10,:] = [8, 4, 0, 2]    # forward long -> vel2
endpose_angle22p5_vel1[11,:] = [8, 4, 0, 3]    # forward long -> vel3
endpose_angle22p5_vel1[12,:] = [7, 5, 1, 1]    # forward turn ccw long ->vel1
endpose_angle22p5_vel1[13,:] = [7, 5, 1, 2]    # forward turn ccw long ->vel2
endpose_angle22p5_vel1[14,:] = [7, 5, 1, 3]    # forward turn ccw long ->vel3
endpose_angle22p5_vel1[15,:] = [8, 2, -1, 1]    # forward turn cw long -> vel1
endpose_angle22p5_vel1[16,:] = [8, 2, -1, 2]    # forward turn cw long -> vel2
endpose_angle22p5_vel1[17,:] = [8, 2, -1, 3]    # forward turn cw long -> vel3

endpose_angle22p5_vel2[0,:] = [2, 1, 0, 1]     # forward -> vel1
endpose_angle22p5_vel2[1,:] = [2, 1, 0, 2]     # forward -> vel2
endpose_angle22p5_vel2[2,:] = [2, 1, 0, 3]     # forward -> vel3
endpose_angle22p5_vel2[3,:] = [3, 2, 1, 1]     # forward turn ccw -> vel1
endpose_angle22p5_vel2[4,:] = [3, 2, 1, 2]     # forward turn ccw -> vel2
endpose_angle22p5_vel2[5,:] = [3, 2, 1, 3]     # forward turn ccw -> vel3
endpose_angle22p5_vel2[6,:] = [4, 1, -1, 1]     # forward turn cw -> vel1 
endpose_angle22p5_vel2[7,:] = [4, 1, -1, 2]     # forward turn cw -> vel2 
endpose_angle22p5_vel2[8,:] = [4, 1, -1, 3]     # forward turn cw -> vel3 
endpose_angle22p5_vel2[9,:] = [8, 4, 0, 2]     # forward long -> vel2
endpose_angle22p5_vel2[10,:] = [8, 4, 0, 3]    # forward long -> vel3
endpose_angle22p5_vel2[11,:] = [7, 5, 1, 2]    # forward turn ccw long ->vel2
endpose_angle22p5_vel2[12,:] = [7, 5, 1, 3]    # forward turn ccw long ->vel3
endpose_angle22p5_vel2[13,:] = [8, 2, -1, 2]    # forward turn cw long -> vel2
endpose_angle22p5_vel2[14,:] = [8, 2, -1, 3]    # forward turn cw long -> vel3

endpose_angle22p5_vel3[0,:] = [2, 1, 0, 2]     # forward -> vel2
endpose_angle22p5_vel3[1,:] = [2, 1, 0, 3]     # forward -> vel3
endpose_angle22p5_vel3[2,:] = [3, 2, 1, 2]     # forward turn ccw -> vel2
endpose_angle22p5_vel3[3,:] = [3, 2, 1, 3]     # forward turn ccw -> vel3
endpose_angle22p5_vel3[4,:] = [4, 1, -1, 2]     # forward turn cw -> vel2 
endpose_angle22p5_vel3[5,:] = [4, 1, -1, 3]     # forward turn cw -> vel3 
endpose_angle22p5_vel3[6,:] = [8, 4, 0, 3]     # forward long -> vel3
endpose_angle22p5_vel3[7,:] = [7, 5, 1, 3]     # forward turn ccw long ->vel3
endpose_angle22p5_vel3[8,:] = [8, 2, -1, 3]     # forward turn cw long -> vel3
...
endpose_angle45_vel0[5,:] = [3, 3, 0, 2]     # forward long -> vel2
endpose_angle45_vel0[6,:] = [2, 4, 1, 1]     # forward turn ccw long ->vel1
endpose_angle45_vel0[7,:] = [2, 4, 1, 2]     # forward turn ccw long ->vel2
...
endpose_angle45_vel1[2,:] = [1, 1, 0, 2]     # forward -> vel2
endpose_angle45_vel1[3,:] = [1, 2, 1, 0]     # forward turn ccw -> vel0
endpose_angle45_vel1[4,:] = [1, 2, 1, 1]     # forward turn ccw -> vel1
endpose_angle45_vel1[5,:] = [1, 2, 1, 2]     # forward turn ccw -> vel2
...
endpose_angle45_vel1[9,:] = [6, 6, 0, 1]     # forward long -> vel1
endpose_angle45_vel1[10,:] = [6, 6, 0, 2]    # forward long -> vel2
endpose_angle45_vel1[11,:] = [6, 6, 0, 3]    # forward long -> vel3
endpose_angle45_vel1[12,:] = [5, 7, 1, 1]    # forward turn ccw long ->vel1
endpose_angle45_vel1[13,:] = [5, 7, 1, 2]    # forward turn ccw long ->vel2
endpose_angle45_vel1[14,:] = [5, 7, 1, 3]    # forward turn ccw long ->vel3
...
endpose_angle45_vel2[0,:] = [1, 1, 0, 1]     # forward -> vel1
endpose_angle45_vel2[1,:] = [1, 1, 0, 2]     # forward -> vel2
endpose_angle45_vel2[2,:] = [1, 1, 0, 3]     # forward -> vel3
endpose_angle45_vel2[3,:] = [2, 4, 1, 1]     # forward turn ccw -> vel1
endpose_angle45_vel2[4,:] = [2, 4, 1, 2]     # forward turn ccw -> vel2
endpose_angle45_vel2[5,:] = [2, 4, 1, 3]     # forward turn ccw -> vel3
...
endpose_angle45_vel2[9,:] = [6, 6, 0, 2]     # forward long -> vel2
endpose_angle45_vel2[10,:] = [6, 6, 0, 3]    # forward long -> vel3
endpose_angle45_vel2[11,:] = [5, 7, 1, 2]    # forward turn ccw long ->vel2
endpose_angle45_vel2[12,:] = [5, 7, 1, 3]    # forward turn ccw long ->vel3
endpose_angle45_vel2[13,:] = [7, 5, -1, 2]    # forward turn cw long -> vel2
endpose_angle45_vel2[14,:] = [7, 5, -1, 3]    # forward turn cw long -> vel3

endpose_angle45_vel3[0,:] = [1, 1, 0, 2]     # forward -> vel2
endpose_angle45_vel3[1,:] = [1, 1, 0, 3]     # forward -> vel3
endpose_angle45_vel3[2,:] = [2, 4, 1, 2]     # forward turn ccw -> vel2
endpose_angle45_vel3[3,:] = [2, 4, 1, 3]     # forward turn ccw -> vel3
...
endpose_angle45_vel3[7,:] = [5, 7, 1, 3]     # forward turn ccw long ->vel3
