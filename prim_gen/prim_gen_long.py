...
endpose_angle0_vel3[3,:] = [12, 0, 0, 4]     # forward long -> vel4
...
endpose_angle0_vel4[3,:] = [16, 0, 0, 5]     # forward long -> vel5

endpose_angle0_vel5[0,:] = [1, 0, 0, 5]     # forward -> vel5
endpose_angle0_vel5[1,:] = [16, 0, 0, 4]     # forward long -> vel4
endpose_angle0_vel5[2,:] = [16, 0, 0, 5]     # forward long -> vel5
...
endpose_angle22p5_vel0[7,:] = [3, 2, 1, 1]     # forward turn long ->vel1
endpose_angle22p5_vel0[8,:] = [4, 1, -1, 1]     # forward turn long -> vel1
...
endpose_angle22p5_vel3[3,:] = [12, 6, 0, 4]     # forward long -> vel4
...
endpose_angle22p5_vel4[3,:] = [16, 8, 0, 5]     # forward long -> vel5

endpose_angle22p5_vel5[0,:] = [2, 1, 0, 5]     # forward -> vel5
endpose_angle22p5_vel5[1,:] = [16, 8, 0, 4]     # forward long -> vel4
endpose_angle22p5_vel5[2,:] = [16, 8, 0, 5]     # forward long -> vel5

# for 45 degrees (2)
##############################################################################
endpose_angle45_veln1[0,:] = [-1, -1, 0, 0]     # backward -> vel0
endpose_angle45_veln1[1,:] = [-1, -1, 0, -1]     # backward -> vel1
endpose_angle45_veln1[2,:] = [-2, -4, 1, 0]     # backward turn ccw -> vel0
endpose_angle45_veln1[3,:] = [-2, -4, 1, -1]     # backward turn ccw -> vel1
endpose_angle45_veln1[4,:] = [-4, -2, -1, 0]   # backward turn cw -> vel0 
endpose_angle45_veln1[5,:] = [-4, -2, -1, -1]   # backward turn cw -> vel1 

endpose_angle45_vel0[0,:] = [-1, -1, 0, 0]     # backward -> vel0
endpose_angle45_vel0[1,:] = [-1, -1, 0, -1]     # backward -> vel1
endpose_angle45_vel0[2,:] = [-2, -4, 1, -1]     # backward turn ccw -> vel1
endpose_angle45_vel0[3,:] = [-4, -2, -1, -1]   # backward turn cw -> vel1 
endpose_angle45_vel0[4,:] = [1, 1, 0, 0]     # forward -> vel0
endpose_angle45_vel0[5,:] = [1, 1, 0, 1]     # forward -> vel1
endpose_angle45_vel0[6,:] = [3, 3, 0, 1]     # forward long -> vel1
endpose_angle45_vel0[7,:] = [2, 4, 1, 1]     # forward turn ccw long ->vel1
...
endpose_angle45_vel3[3,:] = [9, 9, 0, 4]     # forward long -> vel4
endpose_angle45_vel3[4,:] = [5, 7, 1, 2]     # forward turn ccw long ->vel2
endpose_angle45_vel3[5,:] = [5, 7, 1, 3]     # forward turn ccw long ->vel3
endpose_angle45_vel3[6,:] = [7, 5, -1, 2]     # forward turn cw long -> vel2
endpose_angle45_vel3[7,:] = [7, 5, -1, 3]     # forward turn cw long -> vel3
...
endpose_angle45_vel4[3,:] = [12, 12, 0, 5]     # forward long -> vel5

endpose_angle45_vel5[0,:] = [1, 1, 0, 5]     # forward -> vel5
endpose_angle45_vel5[1,:] = [12, 12, 0, 4]     # forward long -> vel4
endpose_angle45_vel5[2,:] = [12, 12, 0, 5]     # forward long -> vel5
