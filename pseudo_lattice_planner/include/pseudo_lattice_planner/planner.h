...
#include <pseudo_lattice_planner/hasher.h>
#include <pseudo_lattice_planner/heap.h>
#include <pseudo_lattice_planner/list.h>
#include <pseudo_lattice_planner/cost_manager.h>
#include <pseudo_lattice_planner/timing_info.h>
#include <pseudo_lattice_planner/Path.h>
...
class LatticePlanner {
    ...
    private:
        ...
        State *setStartState();
        State *setGoalState();
        pseudo_lattice_planner::Path retracePath(State *state);
        ...
        pseudo_lattice_planner::Path current_plan_;    //for visualizing 
