#include <pseudo_lattice_planner/planner_ros.h>
...
PLUGINLIB_EXPORT_CLASS(pseudo_lattice_planner::PseudoLatticePlannerROS,
 ...
 * Default constructor
 ********************************************************************/
PseudoLatticePlannerROS::PseudoLatticePlannerROS() :
    initialized_(false) {}

/********************************************************************
 * Constructor
 ********************************************************************/
PseudoLatticePlannerROS::PseudoLatticePlannerROS(std::string name,
...
/********************************************************************
 ********************************************************************/
void PseudoLatticePlannerROS::initialize(std::string name,
                                costmap_2d::Costmap2DROS *costmap) {
...
void PseudoLatticePlannerROS::initialize(std::string name,
                                costmap_2d::Costmap2DROS *costmap,
                                std::string frame_id) {
    ROS_INFO("PseudoLatticePlannerROS::initialize");
    if (!initialized_) {
        ros::NodeHandle nh;
        ros::NodeHandle private_nh("~/" + name);

        make_plan_srv_ = private_nh.advertiseService("make_plan",
                                        &PseudoLatticePlannerROS::makePlanService,
                                        this);

        replan_service_ = nh.advertiseService("move_base/replan",
                                        &PseudoLatticePlannerROS::replanServiceCallback,
                                        this);
...
/********************************************************************
 ********************************************************************/
bool PseudoLatticePlannerROS::replanServiceCallback(std_srvs::Empty::Request &req,
                                           std_srvs::Empty::Response &resp) {
    ROS_INFO("PseudoLatticePlannerROS::replanServiceCallback");
...
/********************************************************************
 ********************************************************************/
bool PseudoLatticePlannerROS::makePlanService(nav_msgs::GetPlan::Request &req,
                                     nav_msgs::GetPlan::Response &resp) {
    ROS_INFO("PseudoLatticePlannerROS::makePlanService");
...
/********************************************************************
 ********************************************************************/
bool PseudoLatticePlannerROS::makePlan(const geometry_msgs::PoseStamped &start,
                              const geometry_msgs::PoseStamped &goal,
                              std::vector<geometry_msgs::PoseStamped> &plan) {
    ROS_INFO("PseudoLatticePlannerROS::makePlan");
    try {
    ...
    try {
        ...
        ROS_ERROR("pseudo_lattice_planner: could not transform pose into fixed"
                  "frame: %s", ex.what());
    }
...
/********************************************************************
 ********************************************************************/
void PseudoLatticePlannerROS::outlineMap(costmap_2d::Costmap2D *costmap,
                                       unsigned char value) {
